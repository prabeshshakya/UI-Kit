...
<button class="btn btn--grey btn--shadowed--grey m--2x">Primary Button</button>`;
    return(
            <div className="doc-container">
                ...
                <p>
                   This modifier will add shadow to buttons and it has color variant same as the color.
                </p>
                <table className="ui-html-table mt--4x mb--8x">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                Applies primary color shadow to button
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                Applies secondary color shadow to button
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                Applies error color shadow to button
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                Applies waeninf color shadow to button
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                Applies warning-alt color shadow to button
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                Applies grey color shadow to button
                            </td>
                        </tr>
                    </tbody>
                </table>
