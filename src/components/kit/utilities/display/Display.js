	...
	return (
		<div className="page">
			<div className="title-area">
				...
				<p className="lead-text">We can use our display utilities for responsively toggling common values of the display property. Mix it with our grid system, content, or components to show or hide them across specific viewports.</p>
			</div>
			...
			<div className="content-block">
				...
				<p className="page__brief">
					...
					with our responsive display utility classes. We purposely support only a subset of all possible values for <code>display</code>. Classes can be combined for various effects as you need.
				</p>
				...
				<ul className="list-style">
					...
					<li>
						<code>d-[breakpoint]-[value]</code> for <code>sm, md, lg, xl,</code> and <code>xxl</code>.
					</li>
				</ul>
				...
				<p>
					The media queries affect screen widths with the given breakpoint or larger. For example, <code>.d-lg-none</code> sets <code>display: none;</code> on <code>lg, xl,</code> and <code>xxl</code> screens.
				</p>
			</div>
					...
					<Tabs>
						...
						<TabPanel>
							<div className="preview-container">
								<br />
								<div class="d-inline mr-2x mt-5x" style={{ padding: "10px", background: "#ccc" }}>
									d-inline
								</div>
								<div class="d-inline mr-2x" style={{ padding: "10px", background: "#ccc" }}>
									d-inline
								</div>
								<br />
								<br />
								<span class="d-block mb-2x mt-5x" style={{ padding: "10px", background: "#ccc" }}>
									d-block
								</span>
								<span class="d-block mb-2x" style={{ padding: "10px", background: "#ccc" }}>
									d-block
								</span>
							</div>
						</TabPanel>
