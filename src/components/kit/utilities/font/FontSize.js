    ...
    <>
      <div className="content-block">
        ...
        <p className="page__brief">
          We can use the font size utility to quickly change the font size of
          the text. Similar to the color variables, we have the array of
          variables defined for font sizes in the _font.scss file.In the
          <code> _font.scss</code> file, we can find the list of objects defined
          for the different sizes. Then this object (<code>$fontSize</code>) is
          being used in different functions and mixins to apply font sizes as
          needed. We can add or remove font sizes from the variables files as
          required.
          <br />
          We have the <code>getFontSize()</code> function to apply font size
          properties.
        </p>
      </div>
          ...
          <Tabs>
            ...
            <TabPanel>
              <div className="preview-container">
                <div className="title--largest mb-3x">
                ...
                <div className="title--smallest mb-3x">
