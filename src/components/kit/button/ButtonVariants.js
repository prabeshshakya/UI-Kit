...
<div>
  ...
  return (
    <div className="doc-container">
      <h4 className="title title--medium title--dark mb--2x">
        Button Variants
      </h4>
            ...
            <div className="preview-container">
              <div>
                <div className="mb-2x">
                  ...
                  <button className="btn btn--outlined--primary mr-2x">
                    Primary Outlined Button
                  </button>
                  <button className="btn btn--text--primary mr-2x">
                    Primary Text Button
                  </button>
                </div>
                <div className="mb-2x">
                  ...
                  <button className="btn btn--outlined--secondary mr-2x">
                    Secondary Outlined Button
                  </button>
                  <button className="btn btn--text--secondary mr-2x">
                    Secondary Text Button
                  </button>
                </div>
                <div className="mb-2x">
                  <button className="btn btn--error mr-2x">Error Button</button>
                  <button className="btn btn--outlined--error mr-2x">
                    Error Outlined Button
                  </button>
                  <button className="btn btn--text--error mr-2x">
                    Error Text Button
                  </button>
                </div>
                <div className="mb-2x">
                  <button className="btn btn--warning mr-2x">
                    Warning Button
                  </button>
                  <button className="btn btn--outlined--warning mr-2x">
                    Warning Outlined Button
                  </button>
                  <button className="btn btn--text--warning mr-2x">
                    Warning Text Button
                  </button>
                </div>
                <div className="mb-2x">
                  <button className="btn btn--warning-alt mr-2x">
                    Warning Alt Button
                  </button>
                  <button className="btn btn--outlined--warning-alt mr-2x">
                    Warning Alt Outlined Button
                  </button>
                  <button className="btn btn--text--warning-alt mr-2x">
                    Warning Alt Text Button
                  </button>
                </div>
                <div className="mb-2x">
                  <button className="btn btn--grey mr-2x">Grey Button</button>
                  <button className="btn btn--outlined--grey mr-2x">
                    Grey Outlined Button
                  </button>
                  <button className="btn btn--text--grey mr-2x">
                    Grey Text Button
                  </button>
                </div>
                <div>
                  <button className="btn btn--grey btn--rounded mr-2x">
                    Grey Button
                  </button>
                </div>
              </div>
