...
<div>
	...
	return (
		<div className="doc-container">
			<h4>Button Sizes</h4>
			<p className="page__brief">There are several modifier classes that will apply different sizes to a button</p>
				...
				<Tabs>
					...
					<TabPanel>
						<div className="preview-container">
							<div>
								<button className="btn btn--primary btn--large mr-2x mb-2x">Large Button</button>
								<button className="btn btn--primary btn--small m-2x">Small Button</button>
							</div>
							<div>
								<button className="btn btn--error btn--block  mb-2x">Block Button</button>
								<button className="btn btn--outlined--error btn--block">Block Button</button>
							</div>
						</div>
					</TabPanel>
					<TabPanel>
