        ...
        <div className="page">
          <div className="title-area">
            ...
            <p>
              ...
              and naming classes in HTML and CSS to create more maintainable and
              modular code. It's commonly used in web development to improve the
              organization and scalability of stylesheets and front-end code.
              The BEM methodology consists of three main components: Block,
              Element, and Modifier.
            </p>
            <ol>
              <li>
                <b>Block:</b> A block is a standalone component or a
                higher-level element on a webpage that has a meaningful purpose
                on its own. It represents a distinct part of the interface.
                Blocks are usually identified by a single class name that
                describes the block's purpose. For example, a navigation menu, a
                header, or a button can all be considered blocks.
              </li>
              ...
              <li>
                ...
                have a standalone meaning. It's a component that is semantically
                tied to the block it belongs to. Elements are identified by
                combining the block's class with a double underscore (__)
              ...
              <li>
                ...
                block or element. Modifiers are identified by a class name that
                starts with a double dash (--) and is followed by the modifier's
                name.
              </li>
              <li className="code-preview mb-5x">
