		...
		<div className='page'>
			<div className='title-area'>
				...
				<p className='lead-text'>
					We can use our display utilities for responsively toggling common
					values of the display property. Mix it with our grid system, content,
			...
			<div className='content-block'>
				...
				<p className='page__brief'>
					...
					with our responsive display utility classes. We purposely support only
					a subset of all possible values for <code>display</code>. Classes can
				...
				<ul className='list-style'>
					...
					<li>
						<code>d-[breakpoint]-[value]</code> for <code>sm, md, lg, xl,</code>{' '}
						and <code>xxl</code>.
					</li>
				</ul>
