    ...
    <>
      <div className="content-block">
        ...
        <p className="page__brief">
          ...
          direction utilities. By default, the flex-direction is set to
          horizontal i.e. <code>flex-direction: row</code>. However, we may
          encounter situations where we need to change the direction of flex
          items. We can use the following properties for changing the
