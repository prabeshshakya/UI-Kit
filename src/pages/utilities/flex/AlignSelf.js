	...
	return (
		<div className='content-block'>
			...
			<ul className='list-style'>
				...
				<li>
					<code>align-self-center</code>: Element is positioned at the center of
					the container
				</li>
				<li>
					<code>align-self-start</code>: Element is positioned at the beginning
					of the container
				</li>
				<li>
				...
				<li>
					<code>align-self-base</code>: Element is positioned at the baseline of
					the container
				</li>
				<li>
