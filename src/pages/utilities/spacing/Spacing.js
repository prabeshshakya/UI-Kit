        ...
        <div className="page">
          <div className="title-area">
            <div className="content-block">
              ...
              <p className="lead-text">
                ...
                and padding utility classes to modify an element’s appearance.
              </p>
            </div>
          </div>
          <div className="content-block">
            <h3 id="margin-padding">Margin and Padding</h3>
            <p className="page__brief">
              We can assign responsive friendly <code>margin</code> or{" "}
              <code>padding</code> values to an element or subset of its sides
              with shorthand classes. Includes support for individual
              properties, all properties, and vertical and horizontal
              properties. The spacing value can range from <code>-16px</code> to{" "}
              <code>80px</code>.This range can be changed in{" "}
              <code>variables/_spacing.scss</code> file.
            </p>
          </div>
          <div className="content-block">
          ...
          <div className="content-block">
            ...
            <ul>
              ...
              <li>
                <code>...</code> - for classes that set the <code>margin</code>{" "}
                or <code>padding</code> to <code>$spacing * ...</code>
              </li>
              <li>
                <code>20</code> - for classes that set the <code>margin</code>{" "}
                or <code>padding</code> to <code>$spacing * 20</code>
              </li>
              <li>
            ...
            <div>
              <h4 className="mt-4x">Variables</h4>
              <p>
                The variables for the spacing default (
                <code>$defaultSpacing</code>) value is located on{" "}
                <code>variables/_config.scss</code>
              </p>
            </div>

            <h4 id="example" className="mt-4x">
              Example:
            </h4>
            ...
            <h4 id="variables" className="mt-4x">
              Variables
            </h4>
            <p>
              Spacing utilities are declared via Sass loop and then generated
              with our map function.
            </p>
